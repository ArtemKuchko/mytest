...
@section ('input')
    ...
    <h2>Добавление видеоальбома</h2>

    <form action="{{ url('/admin_videofolder_add') }}" method="post" id="contactForm" enctype="multipart/form-data">
        ...
        <div class="control-group form-group">
            <div class="controls">
                <label>Загрузить обложку видеоальбома:</label>
                <input name="myfile" type="file" accept="image/*" class="form-control" id="phone" required>
            </div>
        </div>
