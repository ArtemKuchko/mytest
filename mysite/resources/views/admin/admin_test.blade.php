...
<h1> посмотреть ссылку http://peterjolson.com/using-laravel-and-jquery-file-upload/ </h1>
    <h2>Test for file uploads:</h2>

    <form id="fileupload" action="{{url('/file_upload')}}" method="POST" enctype="multipart/form-data">
